...
/// FIX-05: KillChain state — aktif beberapa detik setelah kill pertama per wave.
/// world.rs pakai ini sebagai Optional component di player query untuk 2× XP multiplier.
...
fn exp_gain_from_kills(
    ...
    // FIX-05: EXP tidak langsung ditambah dari EnemyDied.
    // Enemy mati → spawn XP drop (world.rs spawn_xp_drop).
    // Player harus mendekati drop → collect_xp_drops (world.rs) yang tambah player.exp.
    // KillChain multiplier diterapkan di collect_xp_drops.
